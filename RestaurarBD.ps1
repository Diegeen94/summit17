...
Invoke-WebRequest "http://webjobdatos.blob.core.windows.net/app-log/AdventureWorksDW2014.bak" -OutFile "C:\AdventureWorks\AdventureWorksDW2014.bak"
 
# Connect SQL Server.
$sqlServer = New-Object ('Microsoft.SqlServer.Management.Smo.Server') $sqlName
 
$SqlRestore = "RESTORE DATABASE [AdventureWorksDW2014] FROM  DISK = N'C:\AdventureWorks\AdventureWorksDW2014.bak' WITH  FILE = 1,  MOVE N'AdventureWorksDW2014_Data' TO N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AdventureWorksDW2014_Data.mdf',  MOVE N'AdventureWorksDW2014_Log' TO N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AdventureWorksDW2014_Log.ldf',  NOUNLOAD,  STATS = 5"
$connString = "Server=$sqlname;integrated security= true ;database=master;"
